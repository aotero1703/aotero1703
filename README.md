...
Actualmente formo parte del **Observatorio Nacional de Violencia contra las Mujeres (Ley 30364)**, donde trabajo con bases administrativas, indicadores oficiales y tableros de monitoreo intersectorial.  

📍 **Proyectos destacados:**
- 🟣 *Observatorio Nacional de Violencia* → Integración de registros administrativos (MININTER, MINJUS, MINSA, Ministerio Público y Poder Judicial).  
- 💜 *Warmi Ñan y Observatorio de Acoso Político* → Indicadores trimestrales y tableros Power BI sobre feminicidios, violencia económica y acoso político.  
- 🏡 *Evaluación Línea Final PNVR (MVCS)* → Diseño de cuestionarios SurveyCTO, control de calidad y análisis de resultados.  
- 📈 *ENARES / ENDES / ENUT* → Construcción y validación de sintaxis de indicadores de violencia basados en metodologías oficiales del INEI.
...
| **Comunicación** | Escritura de informes, notas técnicas, boletines e infografías con enfoque de género |

---

### 🌍 Intereses y enfoque
- 🚺 **Igualdad de género y empoderamiento económico**  
- 📊 **Uso de evidencia para decisiones públicas**  
- 🧭 **Diseño de observatorios y tableros de datos**  
- 🌱 **Evaluaciones experimentales y cuasi-experimentales**  
- 💬 **Difusión accesible de resultados: #DatosQuePrevienen**
